...
if args.test_set == 'CSD':
    el_rossinyol = data.CSD(song_name='El Rossinyol', conf_threshold=0.4, example_length=model_args['example_length'], allowed_voices=voices,
    ...
    locus_iste = data.CSD(song_name='Locus Iste', conf_threshold=0.4, example_length=model_args['example_length'], allowed_voices=voices,
                         return_name=True, n_sources=model_args['n_sources'], singer_nb=[3], random_mixes=False,
                         f0_from_mix=f0_cuesta, cunet_original=original_cunet)
    nino_dios = data.CSD(song_name='Nino Dios', conf_threshold=0.4, example_length=model_args['example_length'], allowed_voices=voices,
